...
const STRINGS_EN = {
  ...
  toastMarkedPaid: "Marked as paid in full",
  ...
  fieldDeposit: "Deposit / Paid (zł)",
  addPaymentPlaceholder: "Add a payment (zł)",
  addPaymentBtn: "Add",
...
const STRINGS_PL = {
  ...
  markAsPaidBtn: "Oznacz jako opłacone",
  toastMarkedPaid: "Oznaczono jako w pełni opłacone",
  ...
  fieldDeposit: "Zadatek / Wpłacono (zł)",
  addPaymentPlaceholder: "Dodaj wpłatę (zł)",
  addPaymentBtn: "Dodaj",
